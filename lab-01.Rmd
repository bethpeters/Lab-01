...
NA = Not applicable
There are some attractions that have 'NA' visitors in 2021
...
The data is negatively skewed - there are outliers with large values thus affecting the mean but not the median.
